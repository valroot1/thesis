...
Successivamente è stata sviluppata anche un'interfaccia utente 
...
\begin{itemize}
    ...
    gestione utenti, storico delle richieste, ricerca e server \gls{mcpg}) con 
...
i \textit{tutor} aziendali. Le revisioni periodiche e gli incontri mirati sulle scelte
...
\begin{enumerate}
    \item \textbf{Supporto quotidiano e comunicazione asincrona}: anche durante le giornate svolte da remoto, ero sempre in contatto con i \textit{tutor} aziendali tramite l'applicazione di messaggistica \textit{Slack}. 
