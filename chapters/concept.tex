\newcommand{\makeUC}[9]{
    ...
    % Sostituiamo table e tabular con un unico ambiente longtable
    \small
...
\subsection{UC13 - Visualizzazione messaggi della chat}
\label{13}
\makeUC{UC13}
{Utente}
{
    \begin{itemize}
        \item Il sistema è attivo;
        \item l'utente è autenticato;
        \item l'utente ha selezionato una \textit{chat}.
    \end{itemize}
}
{L'utente visualizza i messaggi della conversazione selezionata.}
{
    \begin{enumerate}
        \item L'utente seleziona una \textit{chat};
...
\makeUC{}
{Utente}
{L'utente sta visualizzando una \textit{chat}.}
