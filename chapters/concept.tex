...
{Il sistema riceve l'email del nuovo utente base.}
...
{Admin}
{L'admin sta eseguendo la creazione di un nuovo utente base.}
{Il sistema riceve la password del nuovo utente base.}
...
\begin{center}
    \begin{xltabular}{\textwidth}{|c|c| >{\arraybackslash}X|c|}
        ...
        \makeReq{1}{L'admin deve poter inserire una email per il nuovo utente base}{3.1}
        \makeReq{1}{L'admin deve poter inserire uno \textit{username} per il nuovo utente base}{3.2}
        \makeReq{1}{L'admin deve poter inserire una password per il nuovo utente base}{3.3}
